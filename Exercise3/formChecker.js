document.addEventListener("DOMContentLoaded",() =>
{
    ...
    {
        //variables
        let n80Quantity = document.getElementById('n80');
        let r68Quantity = document.getElementById('r68');
        let n60Quantity = document.getElementById('n60');
        ...
        //validations
        if (n80Quantity.value == "" && r68Quantity.value == "" && n60Quantity.value == "")
        {
